...
describe("Test clase TemporadaMedia", () => {
    ...
    beforeEach( () => {
        fechaInicio = new Date("22-03-2025");
        fechaFin = new Date("25-05-2025");
    ...
    it("Debe devolver la fecha inicio temporada Media", () => {
        ...
        expect(temporadaMedia.getFechaInicio()).toEqual(fechaInicioTest);
    });

    it("Debe devolver la fecha fin temporada media", () => {
        const fechaFinTest = new Date("25-05-2025");
        expect(temporadaMedia.getFechaFin()).toEqual(fechaFinTest);
    });

    it("Debe devolver el valor de recargo temporada medap", () => {
    ...
    it("Debe establecer la fecha inicio temporada media", () => {
        ...
        expect(temporadaMedia["fechaInicio"]).toEqual(fecha);
    });
    ...
    it("Debe establecer la fecha fin temporada media", () => {
        ...
        expect(temporadaMedia["fechaFin"]).toEqual(fecha);
    });
    ...
    it("Debe devolver que fecha está dentro del rango de fechas temporada media", () => {
        let fechaReserva = new Date("30-11-2025");
    ...
    it("Debe devolver que fecha no está dentro del rango de fechas temporada alta", () => {
        ...
        expect(temporadaMediareservaEnTemporada(fechaReserva)).toEqual(false);
    });
})